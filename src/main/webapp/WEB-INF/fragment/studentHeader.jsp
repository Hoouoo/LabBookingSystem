...
<%if (headerIndex.equals("bookPage.jsp") || headerIndex.equals("seat.jsp") || headerIndex.equals("bookExtendPage.jsp")) {%>
<nav class="py-2 bg-light border-bottom d-flex shadow-sm">
    <div class="container">
        <ul class="nav justify-content-center header-nav-height-4 ">
            <li class="nav-item header-nav-height-2"><a href="/bookPage" class="nav-link link-dark active"
                                                        aria-current="page">실습실 잔여석 조회</a></li>
